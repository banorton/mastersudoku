...
from .solver import is_valid, std_solve, nishio
...
class Puzzle:
    """
    A class to hold the information for the puzzle and interact with the solver.
    ...
    def _init(self, vals):
        ...
        if vals:
            arr = np.reshape(np.array(vals, dtype=int), (9, 9))
        else:
